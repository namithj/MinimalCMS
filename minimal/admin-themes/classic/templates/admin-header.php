...
// Shared admin functions are loaded by mc-includes/admin/bootstrap.php.
...
<link rel="stylesheet" href="<?php echo mc_esc_url(mc_admin_theme_url('assets/css/admin.css')); ?>">
...
<link rel="stylesheet" href="<?php echo mc_esc_url(mc_admin_theme_url('assets/vendor/easymde/easymde.min.css')); ?>">
<script src="<?php echo mc_esc_url(mc_admin_theme_url('assets/vendor/easymde/easymde.min.js')); ?>"></script>
<?php endif; ?>
</head>
<body class="mc-admin theme-classic">
...
<header class="admin-topbar">
				...
				<div class="classic-meta-bar" aria-hidden="true">Control Panel &middot; Build <?php echo mc_esc_html(MC_VERSION); ?></div>
