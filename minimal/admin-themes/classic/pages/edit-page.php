...
/** This filter is documented in admin-themes/classic/templates/admin-header.php. */
...
<?php if ($supports_editor) : ?>
<script src="<?php echo mc_esc_url(mc_admin_theme_url('assets/js/editor.js')); ?>"></script>
<?php endif; ?>

<?php require mc_get_admin_theme_template('templates/admin-footer.php'); ?>
