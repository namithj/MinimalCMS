 ...
 * Vendor Copy Script
 *
 * Copies third-party dist files from node_modules into
 * minimal/admin-themes/default/assets/vendor/
...
const VENDOR_DIR = path.join( ROOT, 'minimal', 'admin-themes', 'default', 'assets', 'vendor' );
...
console.log( `\nDone — ${copied} file(s) copied to minimal/admin-themes/default/assets/vendor/.\n` );
