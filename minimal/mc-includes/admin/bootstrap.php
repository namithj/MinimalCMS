 ...
 * Each admin page includes this file at the top.
 *
 * @package MinimalCMS
 * @since   1.0.0
 */
...
if (! defined('MC_ABSPATH')) {
	require_once dirname(__DIR__, 2) . '/mc-load.php';
}
...
require_once MC_INC . 'admin/functions.php';
...
if (preg_match('#/' . preg_quote($admin_route, '#') . '/([a-zA-Z0-9_-]+\.php)#', $request_uri, $_m)) {
	$admin_page = $_m[1];
}
unset($_m);
